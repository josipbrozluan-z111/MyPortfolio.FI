...
const EmptyState: React.FC = () => (
    <div className="flex flex-col items-center justify-center h-full text-center text-gray-500 dark:text-gray-500">
        <BookOpenIcon className="w-24 h-24 mb-4 text-gray-400 dark:text-gray-600"/>
        <h2 className="text-2xl font-semibold text-gray-600 dark:text-gray-400">Select an entry</h2>
